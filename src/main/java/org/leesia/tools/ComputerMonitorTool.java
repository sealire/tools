...
/**
 * @Auther: leesia
 * @Date: 2018/5/18 20:14
 * @Description:
 */
public class ComputerMonitorTool {
    ...
    public static double getCpuUsage() {
        ...
        if (osName.toLowerCase().contains("windows")
            ...
            try {
                Map<?, ?> map1 = ComputerMonitorTool.cpuinfo();
                Thread.sleep(CPUTIME);
                Map<?, ?> map2 = ComputerMonitorTool.cpuinfo();
    ...
    public static void main(String[] args) throws Exception {
        ...
        double cpuUsage = ComputerMonitorTool.getCpuUsage();
        //当前系统的内存使用率
        double memUsage = ComputerMonitorTool.getMemUsage();
        //当前系统的硬盘使用率
        double diskUsage = ComputerMonitorTool.getDiskUsage();
